...
//                model.addAttribute("title", "그룹 정보 읽어오기 실패!");
...
//        public String editPage(@PathVariable int personid, HttpSession session, Model model) {
////		선택 박스에 넣어줄 그룹 테이블 정보를 읽어오는 리스트
...
//                ContactDto dto = service.getOneContact(personid);
...
//        public String delContact(@PathVariable int personid, Model model) {
//
////		삭제 메소드 실행
//            String status = service.delContact(personid);
//
